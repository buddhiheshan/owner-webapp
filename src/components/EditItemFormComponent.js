...
import { postEditItem } from '../redux/actions/itemActions';
...
class EditItemForm extends Component {
    ...
    constructor(props) {
        ...
        const portions = this.props.selectedItem.portions.map((portion) => (
            {
                name: portion.name,
                price: portion.price
            }
        ...
        this.state = {
            ...
            portions: portions,
            ingredients: this.props.selectedItem.ingredients
    ...
    handleUpload(event) {
        ...
        this.props.dispatchPostEditItem(this.props.selectedItem._id, this.state);
        ...
        return (
            <Form>
                <Form.Group as={Row} controlId="name">
                    ...
                    <Col sm="8">
                        <Form.Control type="text" placeholder={this.name} name="name" value={this.state.name} onChange={this.handleChange} />
                    </Col>
                </Form.Group>
                ...
                <Form.Group as={Row} controlId="category">
                    ...
                    <Col sm="8">
                        <Form.Control type="text" placeholder={this.category} name="category" value={this.state.category} onChange={this.handleChange} />
                    </Col>
                </Form.Group>
                ...
                <Form.Group as={Row} controlId="description">
                    ...
                    <Col sm="8">
                        <Form.Control type="text" placeholder={this.description} name="description" value={this.state.description} onChange={this.handleChange} />
                    </Col>
                </Form.Group>
...
const mapDispatchToProps = dispatch => ({
    dispatchPostEditItem: (itemID, item) => dispatch(postEditItem(itemID, item))
});
